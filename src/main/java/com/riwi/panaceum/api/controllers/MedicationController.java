...
public class MedicationController {
    ...
    @Operation(
        summary = "List all medications with pagination",
        description = "You must submit the page and the page size to get all the corresponding medications"
    )
    @GetMapping
    ...
    @Operation(
        summary = "List a medication by id",
        description = "You must send the id of the medication to search for"
    )     
    @GetMapping(path = "/{id}")
    ...
    @PostMapping
    public ResponseEntity<MedicationResponse> insert(@Validated @RequestBody MedicationRequest request){
